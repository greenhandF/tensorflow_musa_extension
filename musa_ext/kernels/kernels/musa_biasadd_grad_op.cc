...
public:
    ...
    void Compute(OpKernelContext* ctx) override {
        ...
        OP_REQUIRES(ctx, channel_dim >= 0 && channel_dim < output_backprop.dims(),
...
#define REGISTER_MUSA_BIAS_ADD_GRAD(TYPE) \
    REGISTER_KERNEL_BUILDER(Name("BiasAddGrad").Device("MUSA").TypeConstraint<TYPE>("T"), \
