 ...
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    for (int i = 0; i < ctx->num_inputs(); ++i) {
      ...
      Tensor* output = nullptr;
      OP_REQUIRES_OK(ctx, ctx->allocate_output(i, TensorShape({rank}), &output));
...
#define MUSA_SHAPE_INPUT_TYPES \
    {DT_FLOAT, DT_DOUBLE, DT_INT32, DT_INT64, DT_INT16, DT_INT8, DT_UINT8, DT_HALF, DT_BFLOAT16, DT_BOOL}
